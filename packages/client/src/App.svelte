	...
	<header class="flex items-center justify-between px-4 py-2 border-b border-[var(--border)] h-[44px] bg-[var(--bg-secondary)]">
		...
		<div class="flex items-center gap-3">
			...
			{#if appState.playerCounts.total > 0}
				<span class="flex items-center gap-1 text-[11px] text-[var(--text-muted)]" title="{appState.playerCounts.chess} chess, {appState.playerCounts.go} go, {appState.playerCounts.janggi} janggi">
