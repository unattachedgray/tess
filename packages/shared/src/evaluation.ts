...
export const SKILL_SCALE: SkillTier[] = [
	{
		label: "Superhuman",
		maxAcpl: { chess: 25, janggi: 30, go: 15 },
	...
	{
		label: "Pro+",
		maxAcpl: { chess: 45, janggi: 55, go: 30 },
		maxAccuracy: { chess: 88, janggi: 88, go: 90 },
		rating: { chess: "2500-2800", janggi: "2500-2800", go: "4-6 dan" },
		description: "Near-professional accuracy",
	},
	{
		label: "Pro",
		maxAcpl: { chess: 75, janggi: 90, go: 60 },
		maxAccuracy: { chess: 78, janggi: 78, go: 82 },
	...
	{
		label: "Club+",
		maxAcpl: { chess: 120, janggi: 140, go: 100 },
		maxAccuracy: { chess: 68, janggi: 68, go: 70 },
		rating: { chess: "1800-2200", janggi: "1800-2200", go: "1-3 kyu" },
		description: "Strong club player",
	},
	{
		label: "Club",
		maxAcpl: { chess: 180, janggi: 210, go: 150 },
		maxAccuracy: { chess: 55, janggi: 55, go: 58 },
	...
	{
		label: "Casual+",
		maxAcpl: { chess: 260, janggi: 300, go: 220 },
		maxAccuracy: { chess: 42, janggi: 42, go: 42 },
		rating: { chess: "1400-1600", janggi: "1400-1600", go: "9-12 kyu" },
		description: "Above-average casual",
	},
	{
		label: "Casual",
		maxAcpl: { chess: 350, janggi: 400, go: 300 },
		maxAccuracy: { chess: 28, janggi: 28, go: 28 },
